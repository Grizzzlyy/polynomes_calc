...
void RemoveSimilarTerms(struct Polinomial* polynom)
{
...
struct Polinomial* sumPolynoms(struct Polinomial p1, struct Polinomial p2)
{
	...
	RemoveSimilarTerms(result);
	
	return result;
}

struct Polinomial* unaryMinus(struct Polinomial *polynom)
{
